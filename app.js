...
function setActiveModeTab(activeId){
  ["classic-mode","triple-mode","shotclock-mode","chaos-mode","training-mode"].forEach(id=>$(id).classList.toggle("active",id===activeId));
}
...
async function startTraining(){
  ...
  try{
    ...
    document.body.classList.remove("triple-mode","shotclock-mode","chaos-mode");
